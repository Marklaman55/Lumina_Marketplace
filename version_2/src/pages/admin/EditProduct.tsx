...
export default function AdminEditProduct() {
  const { inventory, updateProduct } = useAdmin();
  const { id } = useParams();
  ...
  useEffect(() => {
    if (product) {
      ...
      setSpecs(product.specs.length > 0 ? product.specs : ['']);
    ...
    <div className="max-w-7xl mx-auto space-y-12 pb-32">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1">
            ...
            <h1 className="text-4xl font-display font-black tracking-tight text-gray-900">Edit Product</h1>
            <p className="text-gray-500 font-medium">Refine your product's presence and specifications</p>
        </div>
      ...
      <div className="grid lg:grid-cols-12 gap-12">
        <div className="lg:col-span-8 space-y-12">
            ...
            <section className="bg-white p-10 rounded-[48px] border border-gray-100 shadow-2xl shadow-gray-200/40">
                ...
                <form onSubmit={handleSubmit} id="edit-product-form" className="space-y-10">
